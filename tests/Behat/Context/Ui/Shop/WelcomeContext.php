...
namespace Tests\Guiziweb\SyliusGridAssistantPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Guiziweb\SyliusGridAssistantPlugin\Behat\Page\Shop\WelcomePageInterface;
